...
describe('MovieDetailsComponent', () => {
  ...
  it('should display movie details correctly', () => {
    ...
    expect(compiled.querySelector('.movie-details__title')?.textContent).toContain('Тестовый фильм (2024)');
    expect(compiled.querySelector('.movie-details__rating')?.textContent).toContain('9.9');
    expect(compiled.querySelector('.movie-details__description')?.textContent).toBe('Это описание тестового фильма.');
  ...
  it('should emit close event on close button click', () => {
    ...
    const closeButton = fixture.nativeElement.querySelector('.movie-details__close-btn') as HTMLButtonElement;
  ...
  it('should emit close event on overlay click', () => {
    ...
    const spy = vi.spyOn(component.close, 'emit');
    const overlay = fixture.nativeElement.querySelector('.movie-details__overlay') as HTMLElement;
